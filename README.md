# spider    [![GoDoc](https://godoc.org/github.com/tsuna/gohbase?status.png)](https://godoc.org/github.com/admpub/spider) [![GitHub release](https://img.shields.io/github/release/henrylee2cn/spider.svg)](https://github.com/admpub/spider/releases)

spider（幽灵蛛）是一款纯Go语言编写的支持分布式的高并发、重量级爬虫软件，定位于互联网数据采集，为具备一定Go或JS编程基础的人提供一个只需关注规则定制的功能强大的爬虫工具。
...
![image](https://github.com/admpub/spider/raw/master/doc/icon.png)

* 官方QQ群：Go大数据 42731170    [![Go大数据群](http://pub.idqqimg.com/wpa/images/group.png)](http://jq.qq.com/?_wv=1027&k=XnGGnc)

# 爬虫原理

![image](https://github.com/admpub/spider/raw/master/doc/module.png)

&nbsp;

![image](https://github.com/admpub/spider/raw/master/doc/project.png)

&nbsp;

![image](https://github.com/admpub/spider/raw/master/doc/distribute.png)
...
```
go get -u -v github.com/admpub/spider
```

备注：spider公开维护的spider规则库地址 <https://github.com/admpub/spider_lib>
...
import (
    "github.com/admpub/spider/exec"
    _ "github.com/admpub/spider_lib" // 此为公开维护的spider规则库
...
正常编译方法
```
cd {{replace your gopath}}/src/github.com/admpub/spider
...
spider -h
```
![image](https://github.com/admpub/spider/raw/master/doc/help.jpg)

&nbsp;

> *<font size="2">Web版操作界面截图如下：*

![image](https://github.com/admpub/spider/raw/master/doc/webshow_1.jpg)

&nbsp;

> *<font size="2">GUI版操作界面之模式选择界面截图如下*

![image](https://github.com/admpub/spider/raw/master/doc/guishow_0.jpg)
...
```
$ spider -_ui=cmd -a_mode=0 -c_spider=3,8 -a_outtype=csv -a_thread=20 -a_dockercap=5000 -a_pause=300
-a_proxyminute=0 -a_keyins="<spider><golang>" -a_limit=10 -a_success=true -a_failure=true
```
...
"github.com/admpub/spider_lib" // 此为公开维护的spider规则库
```
> *<font size="2">（在此感谢以上开源项目的支持！）</font>*

# 开源协议

spider（幽灵蛛）项目采用商业应用友好的[Apache License v2](https://github.com/admpub/spider/raw/master/LICENSE).发布
