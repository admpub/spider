...
var replaces = []*Replace{
	&Replace{`github.com/henrylee2cn/spider/`, `github.com/admpub/spider/`, nil, nil},
	&Replace{`github.com/henrylee2cn/`, `github.com/admpub/`, nil, nil},
}

func main() {
	root := filepath.Join(os.Getenv(`GOPATH`), `src`, `github.com/admpub/spider`)
	save := filepath.Join(os.Getenv(`GOPATH`), `src`, `github.com/admpub/spider`)
