...
import (
	...
	"github.com/admpub/spider/common/session"
...
func init() {
	globalSessions, _ = session.NewManager("memory", `{"cookieName":"spiderSession", "enableSetCookie,omitempty": true, "secure": false, "sessionIDHashFunc": "sha1", "sessionIDHashKey": "", "cookieLifeTime": 157680000, "providerConfig": ""}`)
